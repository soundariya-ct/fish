                                    ...
                                    {{ Form::open(['route' => 'admin.product.slices', 'method' => 'POST', 'enctype' => "multipart/form-data", 'class' => 'invoice-repeater' ]) }}
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                <div class="demo-inline-spacing">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" name="is_customizable_product"  value="0" />
                                                        <label class="form-check-label" name="is_customizable_product" >Is Customizable Product?</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div data-repeater-list='products' id='slice'>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach($pieces as $piece)
                                                    <tr>
                                                        <td><img src="{{ Storage::url($piece->slice_image) }}"   width="10%" alt="" /></td>
                                                        <td>{{ $piece->name }}</td>
                                                        <td>{{ $piece->num_of_pieces }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
